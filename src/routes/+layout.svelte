...
>
	...
	>
		...
		>
			...
			<nav class="hidden sm:flex items-center gap-6 ml-8">
				...
				<a href="/schedule" class="text-sm font-medium {pathname === '/schedule' ? 'text-amber-500 dark:text-amber-400' : 'text-gray-500 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white'} transition-colors">Schedule</a>
				<a href="/rules" class="text-sm font-medium {pathname === '/rules' ? 'text-amber-500 dark:text-amber-400' : 'text-gray-500 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white'} transition-colors">Rules</a>
				<a href="/history" class="text-sm font-medium {pathname === '/history' ? 'text-amber-500 dark:text-amber-400' : 'text-gray-500 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white'} transition-colors">History</a>
			</nav>
	...
	<!-- ============ COMPETITION PAUSED BANNER — remove this block to restore normal state ============ -->
	<div class="bg-amber-500 text-black">
		<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-3 flex items-center justify-center gap-3 text-sm sm:text-base font-semibold">
	...
	<nav class="fixed bottom-0 inset-x-0 z-50 bg-white dark:bg-dark-surface border-t border-gray-200 dark:border-dark-border sm:hidden pb-[env(safe-area-inset-bottom)]">
		<div class="grid grid-cols-6 h-14">
			...
			<a href="/schedule" class="flex flex-col items-center justify-center gap-0.5 transition-colors {pathname === '/schedule' ? 'text-amber-500 bg-amber-500/10' : 'text-gray-400 dark:text-gray-500'}">
