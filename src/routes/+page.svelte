    ...
    <div class="max-w-2xl w-full text-center space-y-8">
        ...
        >
            ...
            >
                ...
                <li>
                    Generate <strong>Profit</strong> to break ties and show your
                    dominance.
                </li>
                <li>Top 3 traders get special recognition!</li>
            </ul>
        </div>
        ...
        <div class="pt-4">
            <a
                href="/leaderboard"
                class="inline-flex items-center justify-center px-8 py-4 text-lg font-medium text-white bg-blue-600 rounded-full hover:bg-blue-700 transition-colors shadow-lg hover:shadow-xl transform hover:-translate-y-0.5"
            >
                View Leaderboard
            </a>
        </div>
